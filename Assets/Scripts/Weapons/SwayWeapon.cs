...
public class SwayWeapon : MonoBehaviour
{
    ...
    private void updateSway()
    {
        ...
        Quaternion t_xAngleAdjustment = Quaternion.AngleAxis(-t_xLookInput * 1.2f, Vector3.up);
        Quaternion t_yAngleAdjustment = Quaternion.AngleAxis(-t_yLookInput * 1.2f, Vector3.right);
